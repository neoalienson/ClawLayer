...
class TestStatsCollector(unittest.TestCase):
    ...
    def test_cost_tracking_fast_router(self):
        ...
        # Use longer message to generate meaningful token count
        message = "hello world " * 50  # ~100 words = ~130 tokens
        self.stats.record(message, "quick", 0.5)
    ...
    def test_cost_tracking_semantic_router(self):
        ...
        # Use longer message to generate meaningful token count
        message = "hello world " * 50  # ~100 words = ~130 tokens
        self.stats.record(message, "greeting", 100)
        stats_dict = self.stats.to_dict()
        self.assertGreater(stats_dict['cost_saved'], 0)
